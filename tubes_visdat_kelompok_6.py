...
#read dataset
cvd = pd.read_csv('sample_data/covid_19_indonesia_time_series_all.csv')
cvd.drop_duplicates(subset ="Location", keep = 'first', inplace = False).sort_values(by=['Location']).head(1)
